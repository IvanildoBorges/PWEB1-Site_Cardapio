...
<body>
    <form action="/pweb1/site_cardapio/func/func.php" method="POST">
        ...
        <div class="layout">
            ...
            <input type="text" name="nome" id="um" value="Cachorro Quente" readonly>
            <label for="descricao">Descrição: </label>
            <textarea name="descricao" id="um" readonly>- Cachorro Quente tradicional
- 1 sachê de ketchup
- 1 sachê de maionese</textarea><br>
