...
<body>
    <form action="/pweb1/site_cardapio/func/func.php" method="POST">
        ...
        <div class="layout">
            ...
            <input type="text" name="nome" id="um" value="Pizza" readonly>
            <label for="descricao">Descrição: </label>
            <textarea name="descricao" id="um" readonly>- Pizza de calabresa tamanho G
- 3 sachê de ketchup
- 2 sachê de maionese</textarea><br>
            <label for="dois">Preço: </label>
            <input type="number" name="preco" id="dois" value="30.00" readonly>
