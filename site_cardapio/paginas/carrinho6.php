...
<body>
    <form action="/pweb1/site_cardapio/func/func.php" method="POST">
        ...
        <div class="layout">
            ...
            <input type="text" name="nome" id="um" value="Coxinha de Frango" readonly>
            <label for="descricao">Descrição: </label>
            <textarea name="descricao" id="um" readonly>- Coxinha de Frango
- 2 sachê de ketchup
- 1 sachê de maionese</textarea><br>
            <label for="dois">Preço: </label>
            <input type="number" name="preco" id="dois" value="1.00" readonly>
