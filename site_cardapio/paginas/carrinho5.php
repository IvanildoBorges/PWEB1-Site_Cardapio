...
<body>
    <form action="/pweb1/site_cardapio/func/func.php" method="POST">
        ...
        <div class="layout">
            ...
            <input type="text" name="nome" id="um" value="Pastel de Carne" readonly>
            <label for="descricao">Descrição: </label>
            <textarea name="descricao" id="um" readonly>- Pastel de Carne tamanho familia
- 2 sachê de ketchup
- 2 sachê de maionese</textarea><br>
            <label for="dois">Preço: </label>
            <input type="number" name="preco" id="dois" value="7.00" readonly>
