...
<body>
    <form action="/pweb1/site_cardapio/func/func.php" method="POST">
        ...
        <div class="layout">
            ...
            <input type="text" name="nome" id="um" value="Hamburguer" readonly>
            <label for="descricao">Descrição: </label>
            <textarea name="descricao" id="um" readonly>- Hamburguer tradicional
- 1 sachê de ketchup
- 1 sachê de maionese</textarea><br>
            <label for="dois">Preço: </label>
            <input type="number" name="preco" id="dois" value="15.00" readonly>
